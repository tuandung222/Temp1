...
sidebar_position: 3
description: Danh sách điểm kiến thức cần nắm vững sau mỗi cụm bài giảng để tự đánh giá.
---

# Checklist tự kiểm tra kiến thức

Sau khi đọc xong mỗi cụm bài giảng, hãy quay lại trang này và tự đánh dấu xem bạn đã nắm vững các điểm dưới đây chưa. Nếu một mục bạn không trả lời được, quay lại bài tương ứng đọc thêm.

## Sau Cụm 1 (Lecture 1-2): Foundation
...
## Sau Cụm 2 (Lecture 3): Static Analysis I (BMC + SMT)
...
## Sau Cụm 3 (Lecture 4): Static Analysis II (Concurrency)
...
## Sau Cụm 4 (Lecture 5): Dynamic Analysis (Testing + Fuzzing)
...
## Sau Cụm 5 (Lecture 6 - Case Study)
