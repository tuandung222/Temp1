...
**Thứ nhất, static analysis có giới hạn**. Định lý Rice (đã thấy ở [bài 2.1](../01-introduction/05-formal-verification-intro)) nói mọi property non-trivial về Turing-complete program đều undecidable. Mọi tool BMC phải trade-off: scope giới hạn, soundness vs completeness, scalability. Có những chương trình mà BMC timeout hoặc không scale tới.
